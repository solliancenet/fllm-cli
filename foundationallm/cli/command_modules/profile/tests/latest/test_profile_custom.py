...
from foundationallm.cli.command_modules.profile.custom import (
...
class ProfileCommandTest(unittest.TestCase):
    @mock.patch('foundationallm.cli.core.api.load_subscriptions', autospec=True)
    @mock.patch('foundationallm.cli.command_modules.profile.custom.logger', autospec=True)
    ...
    @mock.patch('foundationallm.cli.command_modules.profile.custom.Profile', autospec=True)
    ...
    def test_login_validate_tenant(self):
        from foundationallm.cli.command_modules.profile._validators import validate_tenant
    ...
    @mock.patch('foundationallm.cli.command_modules.profile.custom._remove_adal_token_cache', autospec=True)
    @mock.patch('foundationallm.cli.command_modules.profile.custom.Profile', autospec=True)
