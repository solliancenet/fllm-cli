...
from foundationallm.cli.core.auth.util import decode_access_token
from foundationallm.cli.core.azclierror import AuthenticationError
from foundationallm.cli.testsdk import LiveScenarioTest
...
class ConditionalAccessScenarioTest(LiveScenarioTest):
    ...
    def test_conditional_access_mfa(self):
        ...
        re_login_command = 'fllm login --scope {scope}'.format(**self.kwargs)
...
class CAEScenarioTest(LiveScenarioTest):
    ...
    def test_cae_scenario(self):
        ...
        assert 'fllm login' in cm.exception.recommendations[0]
