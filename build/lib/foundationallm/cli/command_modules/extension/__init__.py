...
import foundationallm.cli.command_modules.extension._help  # pylint: disable=unused-import
...
class ExtensionCommandsLoader(AzCommandsLoader):
    ...
    def load_command_table(self, args):
        ...
        extension_custom = CliCommandType(operations_tmpl='foundationallm.cli.command_modules.extension.custom#{}')
    ...
    def load_arguments(self, command):
        ...
        from foundationallm.cli.command_modules.extension._completers import (
